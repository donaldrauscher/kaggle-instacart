...
gcloud compute ssh --zone="${ZONE}" --ssh-flag='-D 10000' --ssh-flag='-N' --ssh-flag='-n' "${DATAPROC_CLUSTER_NAME}-m" &
sleep 10 # Wait for tunnel to be ready before opening browser...
