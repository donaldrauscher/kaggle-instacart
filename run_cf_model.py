...
def submit_pyspark_job(dataproc, project_id, cluster_name, pyspark_filepath):
    job_details = {
        'projectId': project_id,
        'job': {
            'placement': {
...
if __name__ == '__main__':
    try:
        ...
        job_id = submit_pyspark_job(dataproc, project_id, cluster_name, pyspark_filepath_full)
